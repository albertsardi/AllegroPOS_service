...
function processViewSettings() {
    ...
    if (settings.header) {
        paperSize.header = {
            contents: phantom.callback(function (pageNum, numPages) {
                var contents = settings.header.contents || '';
                if (settings.headerCallback) {
                    contents = (eval("(" + settings.headerCallback + ")(contents, pageNum, numPages)"));
                }
                return contents.replace(/\{pageNum\}/g, pageNum).replace('{numPages}', numPages);
            }),
    ...
    if (settings.footer) {
        paperSize.footer = {
            contents: phantom.callback(function (pageNum, numPages) {
                var contents = settings.footer.contents || '';
                if (settings.footerCallback) {
                    contents = (eval("(" + settings.footerCallback + ")(contents, pageNum, numPages)"));
                }
                return contents.replace(/\{pageNum\}/g, pageNum).replace('{numPages}', numPages);
            }),
