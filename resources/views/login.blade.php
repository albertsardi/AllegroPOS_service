...
<body class="h-vh-100 bg-brandColor2">
    ...
    <form class="login-form bg-white p-6 mx-auto border bd-default win-shadow"
        ...
        <h2 class="text-light">Login to Allegro.ID</h2>
        <hr class="thin mt-4 mb-4 bg-white">
        <div class="form-group">
            {{-- <input type="text" name="user" data-role="input" data-prepend="<span class='mif-envelop'>" placeholder="Enter your email..." data-validate="required email"> --}}
            <input name="user" type="text" data-role="input" data-prepend="<span class='mif-envelop'>" placeholder="Enter your email..." data-validate="required">
        </div>
        <div class="form-group">
    ...
    <script src="{{ asset('assets/plugin/metro/js/metro.min.js') }}" type="text/javascript"></script>
